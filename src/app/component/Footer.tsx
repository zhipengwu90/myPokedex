...
const NavItem: React.FC<NavItemProps> = ({ href = "/", children }) => (
  <LinkActive
    href={href}
    className="menu-item flex-1 flex justify-center items-center flex flex-col text-gray-600 gap-0.5 text-center border-b-2 transition transition-all hover:bg-blue-50"
